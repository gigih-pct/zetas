<div class="flex flex-col h-full py-10">
    ...
    <div class="px-10 mb-14">
        <a href="/" class="flex items-center gap-4 group">
            <div class="w-10 h-10 bg-construction-yellow flex items-center justify-center font-black text-construction-black rounded-lg shadow-apple group-hover:scale-110 transition-transform duration-300">
                Z
            </div>
            <div>
                <h2 class="font-extrabold text-lg leading-tight tracking-tight text-white uppercase group-hover:text-construction-yellow transition-colors">ZETAS</h2>
                <div class="flex items-center gap-1.5 mt-0.5">
                    <span class="w-1 h-1 bg-construction-yellow rounded-full"></span>
                    <p class="text-[9px] font-bold text-construction-yellow uppercase tracking-[0.3em]">Build & Construct</p>
                </div>
            </div>
        </a>
    </div>
    ...
    <nav class="flex-1 px-6 space-y-2">
        @php
            ...
            $navItemClass = "group flex items-center gap-4 px-4 py-3.5 rounded-xl transition-all duration-300 font-semibold text-[13px] tracking-tight";
        ...
        <div class="pb-3 px-4 text-[10px] font-bold text-white/20 uppercase tracking-[0.2em]">Dashboard</div>
        ...
        <div class="pt-10 pb-3 px-4 text-[10px] font-bold text-white/20 uppercase tracking-[0.2em]">Manajemen</div>
        ...
        <div class="pt-10 pb-3 px-4 text-[10px] font-bold text-white/20 uppercase tracking-[0.2em]">Aset & SDM</div>
    ...
    <div class="px-6 mt-auto">
        <form method="POST" action="{{ route('logout') }}">
            @csrf
            <button type="submit" class="w-full flex items-center justify-center gap-3 px-4 py-4 rounded-2xl bg-white/[0.03] border border-white/[0.05] text-white/40 hover:text-white hover:bg-red-500/20 hover:border-red-500/30 transition-all duration-300 text-xs font-bold uppercase tracking-widest">
